...
class TableViewCellTwo: UITableViewCell {
    static let identifier = "TableViewCellTwo"
    ...
    let mySwitch: UISwitch = {
        ...
        mySwitch.addTarget(self, action: #selector(ViewController.switchChanged(_:)), for: .valueChanged)
        return mySwitch
    }()
    ...
    public func configure(with model: SettingsTwo) {
